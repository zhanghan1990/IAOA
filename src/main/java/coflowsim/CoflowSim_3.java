...
public class CoflowSim_3 {

	public static void main(String[] args) {
		int curArg = 0;
		String dstbasedir = "maxlength";
		...
		String destDirName = "maxlength";
		File dir = new File(destDirName);
		if (dir.exists() == false)
			dir.mkdir();

		for (int i = 0; i <= 16; i++) {
			int maxlength = 200 + 50 * i;
			String tracename = dir.getAbsolutePath() + "/" + 10 + "-" + maxlength + ".tr";
			...
			String fileName = algodir.getAbsolutePath() + "/" + i + ".rt";
