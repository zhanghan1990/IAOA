...
public class Constants {
  ...
  public enum SHARING_ALGO {
    ...
    /**
     * use coflow weight scheduler.
     */
    WEIGHT,
    
    /**
     * use the weight offline
     */
    WEIGHTOFFLINE
  }
  ...
  /***
   * flow base number in the queue
   */
  public static final int E = 1;
  
  /**
   * priority number in the system
   */
  public static final int N = 8;
  
  /**
   * whether work conservation
   */
  public static final boolean bconservation=true;
  ...
  public static int WEIGHTRANGE=4;
}
