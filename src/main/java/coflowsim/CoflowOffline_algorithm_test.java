...
public class CoflowOffline_algorithm_test {

	public static void main(String[] args) {
		int curArg = 0;
		String dstbasedir = "test";
		...
		String tracename = dir.getAbsolutePath() + "/10.tr";
		...
		String fileName = algodir.getAbsolutePath() + "/10.rt";
