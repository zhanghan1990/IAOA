package coflowsim.experiments.width;
import java.io.File;
...
public class CoflowSim_Width_frac {
	public static void main(String[] args) {

		if (args.length < 3) {
			System.out.println(
					"usage./run coflowsim coflowsim.experiments.length.CoflowSim_Width type tracepath destipath");
