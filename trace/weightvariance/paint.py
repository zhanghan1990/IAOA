...
if __name__=='__main__':
	...
	rects1 = ax.bar(ind, improveBarrat, width, hatch="//",color='red',ecolor='k')
	rects2 = ax.bar(ind+width, improVarys, width, hatch='-',color='w',ecolor='k')
	rects3 = ax.bar(ind+2*width, improYosemite, width, hatch='-',color='k',ecolor='k')
	ax.set_xticks(ind+width)
	ax.set_xticklabels(xticklabel)
	ax.legend((rects1[0],rects2[0],rects3[0]), ('Barrat','Varys','Yosemite'),loc=2)
	ax.set_ylabel('improvement over Fair Policy')
