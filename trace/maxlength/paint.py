...
if __name__=='__main__':
	...
	offset=200
	while i<= 14:
		fifo=fifopath+"/Barrat-10-"+str(offset)+".rt"
		sebf=sebfpath+"/Varys-10-"+str(offset)+".rt"
		weight=weightpath+"/Yosemite-10-"+str(offset)+".rt"
	...
	while j < 14:
		...
		improVarys.append(fifolm[j][2]/vary[j][2])
		improYosemite.append(fifolm[j][2]/yo[j][2])
		j+=1

	print yoshort
	xticklabel=('0.2','0.25','0.3','0.35','0.4','0.45','0.5','0.55','0.6','0.65','0.7','0.75','0.8','0.85','0.9')
	xlabel='max length of tasks(GB)'
	#print fifolm
	...
	rects1 = ax.bar(ind, improYosemite, width, hatch="//",color='red',ecolor='k')
	rects2 = ax.bar(ind+width, improVarys, width, hatch='-',color='k',ecolor='k')
