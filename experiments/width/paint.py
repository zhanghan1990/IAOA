...
if __name__=='__main__':
	...
	print yoshort
	xticklabel=('20','25','30','35','40','45','50','55','60','65','70','75','80','85')
	xlabel='fraction of fat coflows'
	#print fifolm
	...
	ax.set_ylim([0,5.0e9])
	#ax.set_ylim([0,3])
	fig.savefig("thin_completion_time.eps",dpi=1000)
	...
	ax.set_xlabel(xlabel)
	ax.set_ylim([0,10.0e9])
	fig.savefig("fat_completion_time.eps",dpi=1000)
